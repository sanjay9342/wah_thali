    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 pb-24 pt-8 sm:px-6 lg:px-8">
        <section className="surface rounded-2xl p-6 text-center">
          ...
          <p className="mt-2 text-muted">Order WH0001 is accepted for Cash on Delivery.</p>
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <Link href="/order/WH0001/track" className="inline-flex h-12 items-center gap-2 rounded-lg bg-red px-5 font-black text-white">
              <ReceiptText size={18} /> Track order
            </Link>
            <Link href="/order/WH0001/invoice" className="inline-flex h-12 items-center gap-2 rounded-lg bg-maroon px-5 font-black text-white">
            ...
            <a
              href={`https://wa.me/${settings.whatsappNumber}?text=${encodeURIComponent("I need help with order WH0001")}`}
